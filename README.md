...
1. Темная и светлая темы приложения.

1. Пресеты с пользовательскими настройками.
   
1. Руководство пользователя (на русском и английском языках).

1. Поддержка нескольких языков интерфейса: Русский, Английский, Хинди, Китайский (упрощенный), Немецкий, Испанский, Французский, Корейский, Португальский.

1. Кроссплатформенность: Windows, Linux.

Приложение тестировалось на Windows 10/11, Linux Ubuntu.

## *Демонстрация*
Версия приложения 3.4.0. 

Режим "Modbus мониторинг":

[Смотреть на GitHub (RU)](https://github.com/user-attachments/assets/51c6fbd3-9bad-4fe3-9091-b8a375b0fb89)

Версия приложения 3.3.3.

Работа с макросами и в режимах "Modbus" и "Без протокола":

[Смотреть на GitHub (RU)](https://github.com/user-attachments/assets/55d66231-dcb7-4a94-a248-c2b8909a0f87)

Также вы можете посмотреть эти ролики на [других площадках](https://andreyabdulkayumov.github.io/TerminalProgram_Website/video.html).

## *Где скачать?*

Приложение выложено на следующих ресурсах:
* [Официальный сайт CoreBus](https://andreyabdulkayumov.github.io/TerminalProgram_Website/downloads.html)

  Тут доступны все публичные версии и материалы по приложению.

* [SourceForge](https://sourceforge.net/projects/corebus/)

	[![Download CoreBus](https://img.shields.io/sourceforge/dt/corebus.svg?style=for-the-badge)](https://sourceforge.net/projects/corebus/files/latest/download)
	
	[![Download CoreBus](https://a.fsdn.com/con/app/sf-download-button)](https://sourceforge.net/projects/corebus/files/latest/download)

* [Chocolatey](https://community.chocolatey.org/packages/corebus)
...
[CoreBus — универсальный Modbus терминал](https://habr.com/ru/articles/1021344/)
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/6c2d48cd-2c7b-4521-89a3-44589fcd38d5"/>
</p>

<p align="center">
  <img src="https://github.com/user-attachments/assets/85d15ba5-dfe9-4f13-94a3-e7396c9efbce"/>
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/15430654-6cc5-464d-826c-7f9762963a6d"/>
</p>

<p align="center">
  <img src="https://github.com/user-attachments/assets/a9222aa1-fd1a-4593-b173-84436a2a0d64"/>
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/bacd6053-50f9-43cd-b311-69278ef31b83"/>
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/3b45c96c-596e-4d89-b5df-4bac5ca8a116"/>
</p>

<p align="center">
  <img src="https://github.com/user-attachments/assets/6aee9cb8-0cbf-4dfb-b006-c7232e31049a"/>
</p>

## *"Modbus мониторинг"*
Специальный режим, предназначенный для визуального контроля подключенного устройства.

В этом режиме отображаются регистры Modbus, значения в которых обновляются с заданным периодом. 
Для удобного отображения эти значения можно привести к выбранному типу, преобразовать по формуле и отобразить на графике.

Также приложение может выступать в качестве логгера и записывать отмеченные регистры в файл на диске.
<p align="center">
  <img src="https://github.com/user-attachments/assets/f6d8c385-875f-4c7f-87a9-1edaf98cae5c"/>
</p>

<p align="center">
  <img src="https://github.com/user-attachments/assets/d57deaaf-9403-44d9-a2ee-24c418199d55"/>
</p>
