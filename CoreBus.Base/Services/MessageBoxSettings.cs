...
public class MessageBoxSettings : IMessageBoxSettings
{
    ...
    public MessageBoxSettings(IUIService uiService, ILocalizationService localization)
    {
    ...
    {
        var messageBox = new MessageBoxManager(SettingsWindow.Instance, _appVersion, _localization);
