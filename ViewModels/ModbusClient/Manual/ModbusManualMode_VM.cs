...
using ViewModels.ModbusClient.Manual.Representations;

namespace ViewModels.ModbusClient.Manual;

public class ModbusManualMode_VM : ReactiveObject
{
    ...
    private object? _requestBuilder_VM;

    public object? RequestBuilder_VM
    {
        get => _requestBuilder_VM;
        set => this.RaiseAndSetIfChanged(ref _requestBuilder_VM, value);
    }
